...
export function FeedbackDetail({ feedbackData }: FeedbackDetailProps) {
    return (
        <Dialog>
                        ...
                        <section className=" w-full space-y-3 ">
                            <div className=" flex flex-col ">
                                ...
                                <div className=" flex items-center space-x-2 ">
                                    ...
                                    <p className=" text-description-color text-base md:text-lg xl:text-xl ">{feedbackData.name}</p>
                                </div>
                            </div>
                            <div className=" flex flex-col ">
                                ...
                                <div className=" flex items-center space-x-2 ">
                                    <FiUsers className=" h-5 w-5 text-description-color "/>
                                    <p className=" text-description-color text-base md:text-lg xl:text-xl ">{feedbackData.createdAt}</p>
                                </div>
                            </div>
                            <div className=" flex flex-col ">
                                ...
                                <div className=" flex items-center space-x-2 ">
                                    ...
                                    <p className=" text-description-color text-base md:text-lg xl:text-xl ">{feedbackData.email}</p>
                                </div>
                            </div>
                            <div className=" flex flex-col w-full">
                                <p className=" text-description-color text-base md:text-lg xl:text-xl font-semibold ">EVENT
                                    DESCRIPTION </p>
                                <p className=" text-description-color text-base md:text-lg xl:text-xl pr-10">{feedbackData.message}</p>
                            </div>
