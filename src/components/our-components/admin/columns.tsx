...
import {ActionAdminComponent} from "@/components/our-components/admin/ActionAdminComponent";
import {AdminType} from "@/lib/admin/AdminData";

export const columnsAdmin: ColumnDef<AdminType>[] = [
    {
        accessorKey: "ID",
        header: ({column}) => (
    ...
    },
    {
        accessorKey: "action",
        header: () => <div></div>,
        cell: ({row}) => <ActionAdminComponent uuid={row.original.uuid} username={row.original.username} status={row.original.status}/>,
    },
];