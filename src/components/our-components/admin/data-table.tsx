...
import { useGetAllUserQuery } from "@/redux/feature/user/Admin";
...
export function AdminComponent() {
    ...
    const { data, isLoading, error } = useGetAllUserQuery({ pageNumber: currentPage - 1, pageSize: itemsPerPage });

    const adminData = data?.content || [];
    ...
    }, [adminData, selectedVerified, selectedStatus, selectedGender]);
        ...
        <section className="w-full flex flex-col">
            <section>
                <div className="flex justify-between items-start sm:items-center gap-4 mb-5">
                    <div>
                        <h1 className="text-title-color text-lg md:text-2xl xl:text-4xl font-bold dark:text-secondary-color-text mb-1 md:mb-2">ADMIN MANAGEMENT</h1>
