        ...
        <Dialog>
            ...
            <DialogContent
                ...
                <section className=" rounded-[6px] border border-gray-400 p-5 ">
                    <h1 className=" text-primary-color text-base md:text-lg xl:text-2xl font-bold mb-5 ">{event.eventTitle}
                    </h1>
                    <section className=" flex gap-5 ">
                        <section className=" w-[50%] space-y-3 ">
                            <div className=" flex items-center space-x-2 ">
                                <RiCalendarScheduleLine className=" h-5 w-5 text-description-color "/>
                                <p className=" text-description-color text-base md:text-lg xl:text-xl ">{event.startedDate}</p>
                            </div>

                            <div className="flex items-center space-x-2">
                                <TfiAlarmClock className="h-5 w-5 text-description-color"/>
                                <p className=" text-description-color text-base md:text-lg xl:text-xl ">{`${format(new Date(event.startedDate), "HH:mm")} - ${format(new Date(event.endedDate), "HH:mm")}`}</p>
                            </div>
                            ...
                            <div className=" flex flex-col ">
                                ...
                                <div className=" flex items-center space-x-2 ">
                                    ...
                                    <p className=" text-description-color text-base md:text-lg xl:text-xl ">{event.createdBy}</p>
                                </div>
                            </div>
                        </section>
                        <Image className=" w-[50%] rounded-[6px]" unoptimized width={100} height={100} src={event.thumbnail}
