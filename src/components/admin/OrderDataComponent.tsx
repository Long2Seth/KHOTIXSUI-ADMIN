                                ...
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead
                                            ...
                                            NAME</TableHead>
                                        <TableHead
                                            className="px-2 py-5 lg:min-w-[200px] text-title-color text-sm md:text-md xl:text-lg dark:text-secondary-color-text">START
                                            DATE</TableHead>
                                        <TableHead
                                            className="px-2 py-5 lg:min-w-[200px] text-title-color text-sm md:text-md xl:text-lg dark:text-secondary-color-text">END
                                            DATE</TableHead>
                                        <TableHead
                                            className="px-2 py-5 lg:min-w-[300px] text-start text-title-color text-sm md:text-md xl:text-lg dark:text-secondary-color-text">LOCATION</TableHead>
                                        <TableHead
                                            className="px-2 py-5 lg:min-w-[100px] text-start text-title-color text-sm md:text-md xl:text-lg dark:text-secondary-color-text">QTY</TableHead>
                                        <TableHead
                                            className="px-2 py-5 lg:min-w-[100px] text-start text-title-color text-sm md:text-md xl:text-lg dark:text-secondary-color-text">PRICE</TableHead>
                                        <TableHead
                                            className="px-2 py-5 lg:min-w-[100px] text-start text-title-color text-sm md:text-md xl:text-lg dark:text-secondary-color-text">TOTAL</TableHead>
                                        <TableHead
                                            className="px-2 py-5 lg:min-w-[200px] text-start text-title-color text-sm md:text-md xl:text-lg dark:text-secondary-color-text">TICKET
                                            TYPE</TableHead>
                                        <TableHead
                                            className="px-2 py-5 lg:min-w-[200px] text-start text-title-color text-sm md:text-md xl:text-lg dark:text-secondary-color-text">STATUS</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
